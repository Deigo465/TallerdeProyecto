...
var (
	mspID        = "" // Org1MSP
	certPath     = "" // path/to/users/user@org1.example.com/msp/signcerts
	keyPath      = "" // /users/Admin@org1.example.com/msp/keystore
	tlsCertPath  = "" ///peers/peer0.org1.example.com/tls/ca.crt"
	peerEndpoint = "" // "localhost:7051"
	gatewayPeer  = "" // "peer0.org1.example.com"
)

func SetupClient(_mspID, _certPath, _keyPath, _tlsCertPath, _peerEndpoint, _gatewayPeer string) *client.Contract {
	mspID = _mspID
	certPath = _certPath
	keyPath = _keyPath
	tlsCertPath = _tlsCertPath
	peerEndpoint = _peerEndpoint
	gatewayPeer = _gatewayPeer
...
func ExampleErrorHandling(err error) {
	...
	// NOTE: for some reason this way of getting the error details makes it not build anymore
